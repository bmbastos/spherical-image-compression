	...
	while processed_images < target:
		...
		if os.path.isfile(full_path):
			...
			BUFFER = {'JPEG_Spherical': {'PSNR':[], 'SSIM':[], 'BPP':[]},
						'RA_Q_RR_S_LowCost': {'PSNR':[], 'SSIM':[], 'BPP':[]},
						'OL_Q_RR_S_LowCost': {'PSNR':[], 'SSIM':[], 'BPP':[]},
						'RA_Q_RC_S_LowCost': {'PSNR':[], 'SSIM':[], 'BPP':[]},
						'OL_Q_RC_S_LowCost': {'PSNR':[], 'SSIM':[], 'BPP':[]},
						'RA_Q_RF_S_LowCost': {'PSNR':[], 'SSIM':[], 'BPP':[]},
						'OL_Q_RF_S_LowCost': {'PSNR':[], 'SSIM':[], 'BPP':[]}}
			...
			for QF in tqdm(quantization_factor):
				...
				BUFFER['RA_Q_RR_S_LowCost']['PSNR'].append(WSPSNR(image, C))
				BUFFER['RA_Q_RR_S_LowCost']['SSIM'].append(WSSSIM(image, C))
				BUFFER['RA_Q_RR_S_LowCost']['BPP'].append(bpp(RaizaPermutation1Prime2))
				...
				BUFFER['OL_Q_RR_S_LowCost']['PSNR'].append(WSPSNR(image, D))
				BUFFER['OL_Q_RR_S_LowCost']['SSIM'].append(WSSSIM(image, D))
				BUFFER['OL_Q_RR_S_LowCost']['BPP'].append(bpp(OliveiraPrime2))
				...
				RaizaPermutation1Prime2 = RaizaPermutation1Prime2.reshape(h, w)
				BUFFER['RA_Q_RC_S_LowCost']['PSNR'].append(WSPSNR(image, E))
				BUFFER['RA_Q_RC_S_LowCost']['SSIM'].append(WSSSIM(image, E))
				BUFFER['RA_Q_RC_S_LowCost']['BPP'].append(bpp(RaizaPermutation1Prime2))
				...
				OliveiraPrime2 = OliveiraPrime2.reshape(h, w)
				BUFFER['OL_Q_RC_S_LowCost']['PSNR'].append(WSPSNR(image, F))
				BUFFER['OL_Q_RC_S_LowCost']['SSIM'].append(WSSSIM(image, F))
				BUFFER['OL_Q_RC_S_LowCost']['BPP'].append(bpp(OliveiraPrime2))
				...
				RaizaPermutation1Prime2 = RaizaPermutation1Prime2.reshape(h, w)
				BUFFER['RA_Q_RF_S_LowCost']['PSNR'].append(WSPSNR(image, G))
				BUFFER['RA_Q_RF_S_LowCost']['SSIM'].append(WSSSIM(image, G))
				BUFFER['RA_Q_RF_S_LowCost']['BPP'].append(bpp(RaizaPermutation1Prime2))
				...
				OliveiraPrime2 = OliveiraPrime2.reshape(h, w)
				BUFFER['OL_Q_RF_S_LowCost']['PSNR'].append(WSPSNR(image, H))
				BUFFER['OL_Q_RF_S_LowCost']['SSIM'].append(WSSSIM(image, H))
				BUFFER['OL_Q_RF_S_LowCost']['BPP'].append(bpp(OliveiraPrime2))
			...
			results.append({'File name':file, 'Method':"Raiza-RR", 'PSNR':BUFFER['RA_Q_RR_S_LowCost']['PSNR'], 'SSIM':BUFFER['RA_Q_RR_S_LowCost']['SSIM'], 'BPP':BUFFER['RA_Q_RR_S_LowCost']['BPP']})
			results.append({'File name':file, 'Method':"Oliveira-RR", 'PSNR':BUFFER['OL_Q_RR_S_LowCost']['PSNR'], 'SSIM':BUFFER['OL_Q_RR_S_LowCost']['SSIM'], 'BPP':BUFFER['OL_Q_RR_S_LowCost']['BPP']})
			results.append({'File name':file, 'Method':"Raiza-RC", 'PSNR':BUFFER['RA_Q_RC_S_LowCost']['PSNR'], 'SSIM':BUFFER['RA_Q_RC_S_LowCost']['SSIM'], 'BPP':BUFFER['RA_Q_RC_S_LowCost']['BPP']})
			results.append({'File name':file, 'Method':"Oliveira-RC", 'PSNR':BUFFER['OL_Q_RC_S_LowCost']['PSNR'], 'SSIM':BUFFER['OL_Q_RC_S_LowCost']['SSIM'], 'BPP':BUFFER['OL_Q_RC_S_LowCost']['BPP']})
			results.append({'File name':file, 'Method':"Raiza-RF", 'PSNR':BUFFER['RA_Q_RF_S_LowCost']['PSNR'], 'SSIM':BUFFER['RA_Q_RF_S_LowCost']['SSIM'], 'BPP':BUFFER['RA_Q_RF_S_LowCost']['BPP']})
			results.append({'File name':file, 'Method':"Oliveira-RF", 'PSNR':BUFFER['OL_Q_RF_S_LowCost']['PSNR'], 'SSIM':BUFFER['OL_Q_RF_S_LowCost']['SSIM'], 'BPP':BUFFER['OL_Q_RF_S_LowCost']['BPP']})
			
		
results = sorted(results, key=itemgetter('File name'))
fieldnames = ['File name', 'Method', 'PSNR', 'SSIM', 'BPP']
with open('Teste_de_np2_rounded_forward_with_LowCost.csv', 'w') as csv_file:
