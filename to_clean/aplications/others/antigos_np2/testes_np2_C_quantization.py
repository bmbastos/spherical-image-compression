...
for file in files:
	...
	if os.path.isfile(full_path):
		...
		BUFFER = {'JPEG_Spherical': {'PSNR':[], 'SSIM':[], 'BPP':[]},
					'BR_Q_CR_S_LowCost': {'PSNR':[], 'SSIM':[], 'BPP':[]},
					'OL_Q_CR_S_LowCost': {'PSNR':[], 'SSIM':[], 'BPP':[]},
					'BR_Q_CC_S_LowCost': {'PSNR':[], 'SSIM':[], 'BPP':[]},
					'OL_Q_CC_S_LowCost': {'PSNR':[], 'SSIM':[], 'BPP':[]},
					'BR_Q_CF_S_LowCost': {'PSNR':[], 'SSIM':[], 'BPP':[]},
		...
		for QF in tqdm(quantization_factor):
			...
			# Brahimi ------------------------------------------------------------------------------------------------------------------------------------- R
			QPhiBrahimiForward = prepareQPhi(image, np2_ceil(divide(QBrahimi, ZO)))
			...
			BUFFER['BR_Q_CR_S_LowCost']['PSNR'].append(WSPSNR(image, C))
			BUFFER['BR_Q_CR_S_LowCost']['SSIM'].append(WSSSIM(image, C))
			BUFFER['BR_Q_CR_S_LowCost']['BPP'].append(bpp(BrahimiPermutation1Prime2))
			...
			BUFFER['BR_Q_CC_S_LowCost']['PSNR'].append(WSPSNR(image, E))
			BUFFER['BR_Q_CC_S_LowCost']['SSIM'].append(WSSSIM(image, E))
			BUFFER['BR_Q_CC_S_LowCost']['BPP'].append(bpp(BrahimiPermutation2Prime2))
			...
			BUFFER['BR_Q_CF_S_LowCost']['PSNR'].append(WSPSNR(image, G))
			BUFFER['BR_Q_CF_S_LowCost']['SSIM'].append(WSSSIM(image, G))
			BUFFER['BR_Q_CF_S_LowCost']['BPP'].append(bpp(BrahimiPermutation3Prime2))
		...
		results.append({'File name':file, 'Method':"Brahimi-CR", 'PSNR':BUFFER['BR_Q_CR_S_LowCost']['PSNR'], 'SSIM':BUFFER['BR_Q_CR_S_LowCost']['SSIM'], 'BPP':BUFFER['BR_Q_CR_S_LowCost']['BPP']})
		...
		results.append({'File name':file, 'Method':"Brahimi-CC", 'PSNR':BUFFER['BR_Q_CC_S_LowCost']['PSNR'], 'SSIM':BUFFER['BR_Q_CC_S_LowCost']['SSIM'], 'BPP':BUFFER['BR_Q_CC_S_LowCost']['BPP']})
		...
		results.append({'File name':file, 'Method':"Brahimi-CF", 'PSNR':BUFFER['BR_Q_CF_S_LowCost']['PSNR'], 'SSIM':BUFFER['BR_Q_CF_S_LowCost']['SSIM'], 'BPP':BUFFER['BR_Q_CF_S_LowCost']['BPP']})
...
with open('Teste_de_np2_C_quantization.csv', 'w') as csv_file:
