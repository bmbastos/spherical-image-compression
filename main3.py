...
axs[0, 0].plot(qf_values, psnr_q_dct, color='green', label="DCT with Q")
axs[0, 0].plot(qf_values, psnr_q_rdct, color='lime', label="RDCT with Q")
axs[0, 0].plot(qf_values, psnr_qbinary_dct, color='orange', label="DCT with ~Q")
axs[0, 0].plot(qf_values, psnr_qbinary_rdct, color='red', label="RDCT with ~Q")
...
axs[0, 1].plot(qf_values, ssim_q_dct, color='green', label="DCT with Q")
axs[0, 1].plot(qf_values, ssim_q_rdct, color='lime', label="RDCT with Q")
axs[0, 1].plot(qf_values, ssim_qbinary_dct, color='orange', label="DCT with ~Q")
axs[0, 1].plot(qf_values, ssim_qbinary_rdct, color='red', label="RDCT with ~Q")
...
axs[1, 0].plot(bpp_q_dct, psnr_q_dct, color='green', label="DCT with Q")
axs[1, 0].plot(bpp_q_rdct, psnr_q_rdct, color='lime', label="RDCT with Q")
axs[1, 0].plot(bpp_qbinary_dct, psnr_qbinary_dct, color='orange', label="DCT with ~Q")
axs[1, 0].plot(bpp_qbinary_rdct, psnr_qbinary_rdct, color='red', label="RDCT with ~Q")
...
axs[1, 1].plot(bpp_q_dct, ssim_q_dct, color='green', label="DCT with Q")
axs[1, 1].plot(bpp_q_rdct, ssim_q_rdct, color='lime', label="RDCT with ~Q")
axs[1, 1].plot(bpp_qbinary_dct, ssim_qbinary_dct, color='orange', label="DCT with Q")
axs[1, 1].plot(bpp_qbinary_rdct, ssim_qbinary_rdct, color='red', label="RDCT with ~Q")
